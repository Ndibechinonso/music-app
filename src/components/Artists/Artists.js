    ...
    return (
        <div className='artistsContainer'>
            ...
            <div className='artistsBody'>
                ...
                {!loader && myArtists ? myArtists.length < 1 ? <div className='emptyDiv'><img src={empty} /> <p>oops, seems like you dont have any data available. Click <a href='https://www.deezer.com/us/' target='_blank'>here</a> to go back to deezer and start streaming.</p></div> :
                ...
                </div> : <div className='spinnerContainer'> <div className="lds-facebook"><div></div><div></div><div></div></div> </div>}
